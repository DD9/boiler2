  ...
  <div class="container">
    <div class="row justify-content-md-center">
      <div class="col-md-8">
        ...
        <p>DD9 starter theme based on Brew, Bones and Bootstrap 4</p>
        <p><a href="https://github.com/DD9/dd9boiler" target="_blank" class="btn btn-secondary btn-lg">Github</a>
          <a href="http://dd9.com" target="_blank" class="btn btn-lg btn-secondary btn-outline-secondary">DD9</a></p>
      </div>
    </div><!-- end .row-->
  </div> <!-- end .container-->
</div> <!-- end #banner-->
