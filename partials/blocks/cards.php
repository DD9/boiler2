...
if( !empty($block['align']) ) {
    $className .= 'block-basic-cards row-outer align' . $block['align'];
}else {
  $className .= 'block-basic-cards row-outer alignfull';
}
...
<section id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($className); ?>">
  ...
  <div class="row">        	
    <div class="col">
      ...
      <ul class="card-deck justify-content-center card-deck-twos">
